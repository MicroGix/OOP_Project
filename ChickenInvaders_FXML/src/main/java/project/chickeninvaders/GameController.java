...
public class GameController extends SceneController {
    ...
    SfxController gameoverSfx = new SfxController("sfx/gameover.wav");
    SfxController shootSfx = new SfxController("sfx/shoot.wav");
    SfxController explodeSfx = new SfxController("sfx/explode.wav");
    SfxController hitSfx = new SfxController("sfx/damaged.wav");
    SfxController ingameSfx = new SfxController("sfx/ingame.wav");
